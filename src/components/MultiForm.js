...
function MultiForm({ heading, headingCenter, formDetails, children }) {
    return (React.createElement("div", { className: "w-11/12 px-4 sm:px-6 lg:px-8  z-0" },
        ...
        React.createElement("form", { action: "", className: "p-8 mt-6 mb-0 space-y-4 rounded-lg bg-white" }, formDetails.map((formDetail) => (React.createElement("div", { key: formDetail.label },
